        ...
        {!weather ? (
          <div role="status" className="animate-pulse">
            <div className="flex items-center justify-center mt-4">
              ...
              <div className="w-10 h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 me-3 ms-3"></div>
              <svg
                className="w-10 h-10 text-gray-200 dark:text-gray-600"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="h-2.5 bg-gray-300 rounded-full dark:bg-gray-700 w-20 mb-2.5 mt-2 mx-auto"></div>
